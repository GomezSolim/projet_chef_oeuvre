...
<body>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Boutique<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="product-details.html">Détails Produits</a></li> 
						...
						<div class="carousel-inner">
							...
							<div class="item active">
								...
								<div class="col-sm-5">
									...
									<p> Centre d'affaire  Solim est le grand marché en ligne au Togo, vous y trouverez toute variété de produits en vente.
	...
	<footer id="footer"><!--Footer-->
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="companyinfo">
							...
							<p>Liste des partenaires ayant fais appels à vos Services</p>
						</div>
					</div>
					<div class="col-sm-7">
						<div class="col-sm-3">
					...
					<div class="col-sm-2">
						<div class="single-widget">
							...
							<ul class="nav nav-pills nav-stacked">
								...
								<li><a href="#">Système de Tickets </a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-2">
						<div class="single-widget">
							...
							<ul class="nav nav-pills nav-stacked">
								<li><a href="#">Information sur la société</a></li>
					...
					<div class="col-sm-3 col-sm-offset-1">
						<div class="single-widget">
							...
							<form action="#" class="searchform">
								...
								<p>Obtenez les mises à jour les plus recentes de  <br />notre site et mettez_vous  à jour vous même...</p>
							</form>
						</div>
					</div>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2022 MaBoutique. Tous les droits réservés.</p>
					<p class="pull-right">Développer par <span><a target="_blank" href="">Esso-solam Gnonike</a></span></p>
				</div>
			</div>
		</div>
