    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <form class="form-horizontal" action="{{ url('/update-produits', $produits_info->produits_id)}}" method="post" enctype="multipart/form-data" >
                    {{ csrf_field() }}
                    <fieldset>
                    <div class="control-group">
                        <label class="control-label" for="produits_nom">Nom Produit</label>
                        <div class="controls">
                        <input type="text" class="input-xlarge" name="produits_nom" value="{{$produits_info->produits_nom}}" required="">
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group hidden-phone">
                        ...
                        <div class="controls">
                        <textarea class="cleditor" name="produits_details" rows="3" required="">
                        {{$produits_info->produits_details}}
                        </textarea>
                        </div>
                    </div>
                    ...
                    <div class="control-group hidden-phone">
                        ...
                        <div class="controls">
                        <textarea class="cleditor" name="produits_description" rows="3" required="">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                        <input type="text" class="input-xlarge" name="produits_prix" value="{{$produits_info->produits_prix}}" required="">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                        <input type="text" class="input-xlarge" name="produits_taille" value="{{$produits_info->produits_taille}}" required="">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                        <input type="text" class="input-xlarge" name="produits_couleur" value="{{$produits_info->produits_couleur}}" required="">
                        </div>
                    </div>
